...
contract FreshCodexNemesisZeroRewardReplayTest is Test {
    ...
    function test_zeroRewardTokenCannotBeReplayedToExhaustOwnerVotingCap() public {
        ...
        JB721Distributor control = new JB721Distributor(directory, address(0), address(0), address(0), 1 days, 4, 0);
        JB721Distributor attacked = new JB721Distributor(directory, address(0), address(0), address(0), 1 days, 4, 0);
